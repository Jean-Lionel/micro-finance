...
<body>
    ...
    <h5 class="my-0 mr-md-auto font-weight-normal"><a href="{{ route('clients.index')}}"><i class="fa fa-home"></i>  COPDI BURUNDI</a></h5>
    <nav class="my-2 my-md-0 mr-md-3">
      <a class="p-2 text-dark" href="{{ route('clients.index') }}">
        <i class="fa fa-male"></i> <i class="fa fa-female"> </i>Client</a>
